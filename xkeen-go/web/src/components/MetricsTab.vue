...
<template>
  <div class="metrics-wrapper">
    ...
    <div v-if="!loading && !available" class="metrics-unavailable">
      <svg viewBox="0 0 24 24" width="48" height="48" fill="none" stroke="var(--error)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="unavailable-icon">
