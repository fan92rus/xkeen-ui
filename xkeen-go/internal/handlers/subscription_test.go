...
func TestFetchSubscription_WithMockServer(t *testing.T) {
	...
	vlessURI := "vless://d9819f3a-8ff2-0012-ad57-dfd05beeaa72@1.2.3.4:443?encryption=none&flow=xtls-rprx-vision&type=tcp&security=reality&sni=example.com&fp=chrome&pbk=testkey&sid=abcd1234#TestNode"
